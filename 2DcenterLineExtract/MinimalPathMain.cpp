...
int Test_SpeedToPath_RegularStepGradientDescent_ND(int argc, char* argv[])
{
	...
	try
	{
		// Get arguments
		unsigned int argi = 1;
		char* OutputFilename = "result.png";
		char* SpeedFilename = "Real-DSA-01-Speed-01.mhd";
		char* PathFilename = "Real-DSA-01.path";
		float TerminationValue = 2.0;
		unsigned int NumberOfIterations = 1000;
		float StepLengthFactor = 1.0;
		float StepLengthRelax = 0.999;
		// NOTE: Points will be read from the command line later
